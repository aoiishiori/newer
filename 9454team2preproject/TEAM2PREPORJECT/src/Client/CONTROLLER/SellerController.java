...
public class SellerController implements Initializable {
        ...
        dlg.showAndWait().ifPresent(ok -> {
            ...
            try {
                String[] res = sellerModel.addProduct(username,
                        ...
                        Double.parseDouble(op.getText().trim()),
                        Double.parseDouble(dp.getText().trim()),
    ...
    public static class ProductRow {
        private final String productId, name, category, price, quantity, expiryDate, status;
        public ProductRow(String productId, String name, String category,
            ...
            this.productId = productId; this.name = name; this.category = category;
            this.price = price; this.quantity = quantity;
            this.expiryDate = expiryDate; this.status = status;
        }
